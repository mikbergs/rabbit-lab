...
class Program
{
    ...
    private static string DEFAULT_CONTAINER_ID = "client-2";
    private static string DEFAULT_SUBSCRIPTION_NAME = "test-subscription-2";
    ...
    static async Task Main(string[] args)
    {
        ...
        Console.WriteLine($" [*] Receiver 2 (queue: {tempQueueName}) waiting for messages. To exit press CTRL+C");
